...
class ListSoldVehiclesAcceptanceTest {
    ...
    fun `the system has multiple sold vehicles`() {
        createVehicles(
            listOf(
                vehicleRequest(price = 30000L, make = "Fiat", model = "Uno", status = "SOLD"),
                vehicleRequest(price = 25000L, make = "Ford", model = "Fiesta", status = "SOLD"),
                vehicleRequest(price = 28000L, make = "Volkswagen", model = "Gol", status = "SOLD"),
            )
        )
    }
    ...
    @Then(
        "the system should return a list of all sold vehicles ordered by price in ascending order"
    )
    fun `the system should return a list of all sold vehicles ordered by price in ascending order`() {
